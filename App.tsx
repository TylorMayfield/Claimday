...
import { useSettlementsStore } from './src/hooks/useSettlementsStore';
import { evaluateSettlement } from './src/utils/eligibility';
...
const CATEGORIES = ['All', 'Data breach', 'Employment', 'False advertising', 'General settlement', 'Subscription'];
...
export default function App() {
  ...
  const selectedSettlement =
    selected && sorted.some((item) => item.id === selected.id)
      ? selected
      : sorted[0] ?? null;
            ...
            <Card style={styles.hero} mode="contained">
              <Card.Content>
                ...
                <Text variant="bodyLarge" style={styles.heroBody}>
                  Browse live settlements, see likely fit based on location and history, and mark
                  which claims you already handled.
                </Text>
                ...
                {error ? (
                  <Text variant="bodySmall" style={styles.refreshError}>
                    {error}
                  </Text>
                ) : null}
              </Card.Content>
            ...
            <Card style={styles.profileCard}>
              <Card.Content>
                ...
                <Text variant="bodySmall" style={styles.profileSubtitle}>
                  Set once — powers eligibility scores across all settlements.
                </Text>
                ...
                <Text variant="labelMedium" style={styles.keywordsLabel}>
                  Keywords
                </Text>
                <Text variant="bodySmall" style={styles.profileSubtitle}>
                  Add companies, products, employers, or topics relevant to you.
                </Text>
                <View style={styles.chipRow}>
                  {profile.keywords.map((kw) => (
                    <Chip key={kw} onClose={() => removeKeyword(kw)} compact>
                      {kw}
                    </Chip>
                  ))}
                </View>
                ...
                <View style={styles.switchRow}>
                  ...
                  <Switch
                    ...
                    onValueChange={(v) => updateProfile({ hasProof: v })}
                  />
                </View>
              </Card.Content>
            </Card>
                ...
                <Card.Content>
                  ...
                  <View style={styles.actionRow}>
                    ...
                    <Button
                      ...
                      onPress={() =>
                        Linking.openURL(
                          selectedSettlement.claimUrl ?? selectedSettlement.sourceUrl,
                        ).catch(() => undefined)
                      }
                    >
                      Open claim
